...
class IngresosApp:
    def __init__(self, root, id_usuario, db_connection):
        ...
        # Título
        self.titulo = Label(self.miFrame, text="AÑADIR INGRESOS", bg="#31C0E0", width=1000, height=1)
        ...
        # Combobox categorías
        self.combo = ttk.Combobox(self.miFrame, state="readonly", values=["Seleccionar categoría", "Sueldo", "Otro"])
...
if __name__ == "__main__":
    ...
    app = IngresosApp(root, id_usuario=usuario_actual_id, db_connection=_ConnectionBase)
    root.mainloop()
